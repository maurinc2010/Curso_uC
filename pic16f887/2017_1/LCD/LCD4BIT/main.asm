...
;CONFIGURACIÓN DE PUERTOS C Y E COMO SALIDA
    ...
    MOVLW	32
    CALL	COMAND4			;POR QUE LO PIDE EL FABRICANTE

    MOVLW	28
    CALL	COMAND4			;CUATRP BITS
    ...
    BUCLE	MOVLW	B'00000001'	;BORRA Y REGRESA A CERO
    CALL	COMAND4	
    CLRF    REG7
...
COMAND4	BCF		PORTE,0		;ENVIO DE COMANDO (JULIAN, EL BIT DEL PROTEUS ES EL INVERTIDO DEL DATASHEET)
		GOTO	$+2
DATO4	BSF		PORTE,0			;ENVIO DE DATO
		MOVWF	REG6
		MOVLW	B'00001111'
		ANDWF	PORTC,1
		MOVF	REG6,0
